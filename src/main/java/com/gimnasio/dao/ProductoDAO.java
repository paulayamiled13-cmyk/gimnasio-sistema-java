...
public class ProductoDAO {
    ...
    // CONSULTA DE UNA TABLA: consulta únicamente la tabla producto
    ...
    public void insertar(Producto p) throws SQLException {
        String sql = "INSERT INTO producto(id_usuario, nombre_producto, descripcion, precio, stock, estado) " +
                "VALUES(?,?,?,?,?,?)";
    ...
    public void actualizar(Producto p) throws SQLException {
        String sql = "UPDATE producto " +
                "SET nombre_producto=?, descripcion=?, precio=?, stock=?, estado=? " +
                "WHERE id_producto=?";
    ...
    // ELIMINACIÓN LÓGICA:
    // no borra el producto, solo cambia su estado a Inactivo
    ...
    // ELIMINACIÓN FÍSICA:
    // borra definitivamente el producto de la tabla producto
    public void eliminarFisico(int idProducto) throws SQLException {
